...
if __name__ == "__main__":
    # for env in ["Swimmer-v4", "Humanoid-v4", "InvertedDoublePendulum-v4", "Walker2d-v4", 'Reacher-v4', "Ant-v4", "HalfCheetah-v4", "Hopper-v4", "InvertedPendulum-v4", "Pusher-v4"]:
    #     patterns_dict = {
    ...
    for env in ["Humanoid-v4"]:
        patterns_dict = {
            ...
            # 'sdac_no_alpha': r".*/sdac.*random_seed_101_105_noise",
            'lambda_0.01': r".*/sdac_soft_v2.*random_seed_100_104_new_version1_entropy_lambda_0.01",
            'lambda_0.05': r".*/sdac_soft_v2.*random_seed_100_104_new_version1_entropy_lambda_0.05",
            'lambda_0.1': r".*/sdac_soft_v2.*random_seed_100_104_new_version1_entropy_lambda_0.1",
            'lambda_0.2': r".*/sdac_soft_v2.*random_seed_100_104_new_version1_entropy_lambda_0.2",
        }
        plot_mean(patterns_dict, env, f"figures/{env}_sdac_soft.png")
        for pattern in patterns_dict:
            print(pattern)
            load_best_results(patterns_dict[pattern], env)