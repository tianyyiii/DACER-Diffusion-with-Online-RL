...
class Algorithm:
    ...
    def _implement_common_behavior(self, stateless_update, stateless_get_action, stateless_get_deterministic_action, stateless_get_noisy_action, stateless_get_value=None):
        ...
        self._get_noisy_action = jax.jit(stateless_get_noisy_action)
